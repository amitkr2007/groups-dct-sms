...
namespace MT.Framework.UI.Windows
{
    ...
    public class WindowBase : Window
    {
        ...
        private void OnAttachCloseButton()
        {
            ...
            Button btnClose = GetChildControl<Button>("PART_CLOSE");
            if (btnClose != null)
            {
        ...
        private readonly RoutedUICommand _cmdMinimize = new RoutedUICommand
            ("Minimize", "", typeof(MT.Framework.UI.Windows.WindowBase));

        private readonly RoutedUICommand _cmdMaximize = new RoutedUICommand
            ("Maximize", "", typeof(MT.Framework.UI.Windows.WindowBase));

        public static DependencyPropertyKey _proMaximizeKey = DependencyProperty.RegisterReadOnly
            ("Maximized", typeof(bool), typeof(MT.Framework.UI.Windows.WindowBase), new PropertyMetadata(false));
