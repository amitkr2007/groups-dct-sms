...
namespace GROUPS.WPF.UI.Windows
{
    /// <summary>
    /// Custom Window
    /// </summary>     
    ...
    public partial class WindowBase : Window
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="WindowBase"/> is maximized
        /// </summary>
        ...
        private readonly RoutedUICommand MinimizeCommand =
            new RoutedUICommand("Minimize", "Minimize", typeof(WindowBase));

        /// <summary>
        /// Maximize / Restore command
        /// </summary>
        private readonly RoutedUICommand MaximizeRestoreCommand =
            new RoutedUICommand("MaximizeRestore", "MaximizeRestore", typeof(WindowBase));
    }
}
