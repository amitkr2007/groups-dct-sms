...
namespace RibbonWindowSample.ViewModel
{
    public static class WordModel
    {
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/NewDocument_16x16.png", UriKind.Relative),
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/Open_16x16.png", UriKind.Relative),
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/Save_16x16.png", UriKind.Relative),
                            ToolTipTitle = TooTipTitle,
                            Command = new DelegateCommand(DefaultExecuted, DefaultCanExecute),
                        };
                        _dataCollection[Str] = menuItemData;
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/Document_16x16.png", UriKind.Relative),
                            ToolTipTitle = TooTipTitle,
                            Command = new DelegateCommand(DefaultExecuted, DefaultCanExecute),
                            KeyTip = "W",
                        };
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/Print_16x16.png", UriKind.Relative),
                            ToolTipTitle = TooTipTitle,
                            Command = new DelegateCommand(DefaultExecuted, DefaultCanExecute),
                        };
                        _dataCollection[Str] = splitMenuItemData;
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/PrintPreview_16x16.png", UriKind.Relative),
                            ToolTipTitle = ToolTipTitle,
                            Command = new DelegateCommand(DefaultExecuted, DefaultCanExecute),
                            KeyTip = "V",
                        };
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/NewPermission_32x32.png", UriKind.Relative),
                            ToolTipTitle = TooTipTitle,
                            Command = new DelegateCommand(DefaultExecuted, DefaultCanExecute),
                            KeyTip = "R",
                        };
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/SendLinkByEmail_32x32.png", UriKind.Relative),
                            Command = new DelegateCommand(DefaultExecuted, DefaultCanExecute),
                        };
                        _dataCollection[Str] = menuItemData;
                    }
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/Printer_48x48.png", UriKind.Relative),
                            ToolTipTitle = ToolTipTitle,
                            Command = new DelegateCommand(DefaultExecuted, DefaultCanExecute),
                            KeyTip = "X",
                        };
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/PublishPlan_16x16.png", UriKind.Relative),
                            Command = new DelegateCommand(DefaultExecuted, DefaultCanExecute),
                        };
                        _dataCollection[Str] = menuItemData;
                    }
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/ConnectionManager_48x48.png", UriKind.Relative),
                            ToolTipTitle = ToolTipTitle,
                            Command = new DelegateCommand(DefaultExecuted, DefaultCanExecute),
                            KeyTip = "B",
                        };
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/FolderClose_48x48.png", UriKind.Relative),
                            Command = new DelegateCommand(DefaultExecuted, DefaultCanExecute),
                        };
                        _dataCollection[Str] = menuItemData;
                    }
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/Options_16x16.png", UriKind.Relative),
                            Command = new DelegateCommand(DefaultExecuted, DefaultCanExecute),
                            KeyTip = "I",
                        };
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/Close_16x16.png", UriKind.Relative),
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/Help_16x16.png", UriKind.Relative),
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        GroupData Data = new GroupData(Str)
                        {
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/Font_16x16.png", UriKind.Relative),
                            LargeImage = new Uri("/RibbonWindowSample;component/Images/Font_32x32.png", UriKind.Relative),
                            KeyTip = "ZF",
                        };
                        _dataCollection[Str] = Data;
                    }
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/Cut_16x16.png", UriKind.Relative),
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/Copy_16x16.png", UriKind.Relative),
                            ToolTipTitle = ToolTipTitle,
                            ToolTipDescription = ToolTipDescription,
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/FormatPainter_16x16.png", UriKind.Relative),
                            ToolTipTitle = ToolTipTitle,
                            ToolTipDescription = ToolTipDescription,
                            ToolTipFooterTitle = HelpFooterTitle,
                            ToolTipFooterImage = new Uri("/RibbonWindowSample;component/Images/Help_16x16.png", UriKind.Relative),
                            Command = new DelegateCommand(DefaultExecuted, DefaultCanExecute),
                            KeyTip = "FP",
                        };
                        _dataCollection[Str] = buttonData;
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        ButtonData buttonData = new ButtonData()
                        {
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/ClearFormatting_16x16.png", UriKind.Relative),
                            ToolTipTitle = ToolTipTitle,
                            ToolTipDescription = ToolTipDescription,
                            ToolTipFooterTitle = HelpFooterTitle,
                            ToolTipFooterImage = new Uri("/RibbonWindowSample;component/Images/Help_16x16.png", UriKind.Relative),
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/Bold_16x16.png", UriKind.Relative),
                            ToolTipTitle = ToolTipTitle,
                            ToolTipDescription = ToolTipDescription,
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        ToggleButtonData toggleButtonData = new ToggleButtonData()
                        {
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/Italic_16x16.png", UriKind.Relative),
                            ToolTipTitle = ToolTipTitle,
                            ToolTipDescription = ToolTipDescription,
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        SplitButtonData splitButtonData = new SplitButtonData()
                        {
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/LineColor_16x16.png", UriKind.Relative),
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/Color_16x16.png", UriKind.Relative),
                            Command = new DelegateCommand(DefaultExecuted, DefaultCanExecute),
                        };
                    }
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        ToggleButtonData toggleButtonData = new ToggleButtonData()
                        {
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/Erase_16x16.png", UriKind.Relative),
                            ToolTipTitle = ToolTipTitle,
                            ToolTipDescription = ToolTipDescription,
                            Command = new DelegateCommand(DefaultExecuted, DefaultCanExecute),
                            KeyTip = "4",
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        ToggleButtonData toggleButtonData = new ToggleButtonData()
                        {
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/FontScript_16x16.png", UriKind.Relative),
                            ToolTipTitle = ToolTipTitle,
                            ToolTipDescription = ToolTipDescription,
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        SplitMenuItemData splitMenuItemData = new SplitMenuItemData()
                        {
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/FontColor_16x16.png", UriKind.Relative),
                            ToolTipTitle = ToolTipTitle,
                            ToolTipDescription = ToolTipDescription,
                            ToolTipFooterTitle = HelpFooterTitle,
                            ToolTipFooterImage = new Uri("/RibbonWindowSample;component/Images/Help_16x16.png", UriKind.Relative),
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        GroupData Data = new GroupData(Str)
                        {
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/Paragraph_16x16.png", UriKind.Relative),
                            LargeImage = new Uri("/RibbonWindowSample;component/Images/Paragraph_32x32.png", UriKind.Relative),
                            KeyTip = "ZP",
                        };
                        _dataCollection[Str] = Data;
                    }
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        SplitButtonData splitButtonData = new SplitButtonData()
                        {
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/Bullets_16x16.png", UriKind.Relative),
                            ToolTipTitle = ToolTipTitle,
                            ToolTipDescription = ToolTipDescription,
                            IsCheckable = true,
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/MultiLevelList_16x16.png", UriKind.Relative),
                            Command = new DelegateCommand(DefaultExecuted, DefaultCanExecute),
                        };
                    }
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        SplitButtonData splitButtonData = new SplitButtonData()
                        {
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/Numbering_16x16.png", UriKind.Relative),
                            ToolTipTitle = ToolTipTitle,
                            ToolTipDescription = ToolTipDescription,
                            IsCheckable = true,
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        ButtonData buttonData = new ButtonData()
                        {
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/DecreaseIndent_16x16.png", UriKind.Relative),
                            ToolTipTitle = ToolTipTitle,
                            ToolTipDescription = ToolTipDescription,
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        ButtonData buttonData = new ButtonData()
                        {
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/IncreaseIndent_16x16.png", UriKind.Relative),
                            ToolTipTitle = ToolTipTitle,
                            ToolTipDescription = ToolTipDescription,
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        ButtonData buttonData = new ButtonData()
                        {
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/Sort_16x16.png", UriKind.Relative),
                            ToolTipTitle = ToolTipTitle,
                            ToolTipDescription = ToolTipDescription,
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        ToggleButtonData toggleButtonData = new ToggleButtonData()
                        {
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/ShowHide_16x16.png", UriKind.Relative),
                            ToolTipTitle = ToolTipTitle,
                            ToolTipDescription = ToolTipDescription,
                            ToolTipFooterTitle = ToolTipFooterTitle,
                            ToolTipFooterImage = new Uri("/RibbonWindowSample;component/Images/Help_16x16.png", UriKind.Relative),
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/AlignLeft_16x16.png", UriKind.Relative),
                            ToolTipTitle = ToolTipTitle,
                            ToolTipDescription = ToolTipDescription,
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        RadioButtonData radioButtonData = new RadioButtonData()
                        {
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/AlignCenter_16x16.png", UriKind.Relative),
                            ToolTipTitle = ToolTipTitle,
                            ToolTipDescription = ToolTipDescription,
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        RadioButtonData radioButtonData = new RadioButtonData()
                        {
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/AlignRight_16x16.png", UriKind.Relative),
                            ToolTipTitle = ToolTipTitle,
                            ToolTipDescription = ToolTipDescription,
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        RadioButtonData radioButtonData = new RadioButtonData()
                        {
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/Justify_16x16.png", UriKind.Relative),
                            ToolTipTitle = ToolTipTitle,
                            ToolTipDescription = ToolTipDescription,
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        MenuButtonData menuButtonData = new MenuButtonData()
                        {
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/LineSpacing_16x16.png", UriKind.Relative),
                            ToolTipTitle = ToolTipTitle,
                            ToolTipDescription = ToolTipDescription,
                            Command = new DelegateCommand(DefaultExecuted, DefaultCanExecute),
                            KeyTip = "K",
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/UpArrow_16x16.png", UriKind.Relative),
                            Command = new DelegateCommand(DefaultExecuted, DefaultCanExecute),
                        };
                    }
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/DownArrow_16x16.png", UriKind.Relative),
                            Command = new DelegateCommand(DefaultExecuted, DefaultCanExecute),
                        };
                    }
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        SplitButtonData splitButtonData = new SplitButtonData()
                        {
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/Shading_16x16.png", UriKind.Relative),
                            ToolTipTitle = ToolTipTitle,
                            ToolTipDescription = ToolTipDescription,
                            ToolTipFooterTitle = ToolTipFooterTitle,
                            ToolTipFooterImage = new Uri("/RibbonWindowSample;component/Images/Help_16x16.png", UriKind.Relative),
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        SplitButtonData splitButtonData = new SplitButtonData()
                        {
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/Borders_16x16.png", UriKind.Relative),
                            ToolTipTitle = ToolTipTitle,
                            IsCheckable = true,
                            Command = new DelegateCommand(DefaultExecuted, DefaultCanExecute),
                            KeyTip = "B",
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/BottomBorder_16x16.png", UriKind.Relative),
                            IsCheckable = true,
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/TopBorder_16x16.png", UriKind.Relative),
                            IsCheckable = true,
                            Command = new DelegateCommand<MenuItemData>(BorderMenuItemDefaultExecute, BordersMenuItemDefaultCanExecute),
                        };
                    }
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/LeftBorder_16x16.png", UriKind.Relative),
                            IsCheckable = true,
                            Command = new DelegateCommand<MenuItemData>(BorderMenuItemDefaultExecute, BordersMenuItemDefaultCanExecute),
                        };
                    }
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/RightBorder_16x16.png", UriKind.Relative),
                            IsCheckable = true,
                            Command = new DelegateCommand<MenuItemData>(BorderMenuItemDefaultExecute, BordersMenuItemDefaultCanExecute),
                        };
                    }
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/NoBorder_16x16.png", UriKind.Relative),
                            Command = new DelegateCommand<MenuItemData>(BorderMenuItemDefaultExecute, BordersMenuItemDefaultCanExecute),
                        };
                    }
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/InsideBorders_16x16.png", UriKind.Relative),
                            IsCheckable = true,
                            Command = new DelegateCommand<MenuItemData>(BorderMenuItemDefaultExecute, BordersMenuItemDefaultCanExecute),
                        };
                    }
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/OuterBorders_16x16.png", UriKind.Relative),
                            IsCheckable = true,
                            Command = new DelegateCommand<MenuItemData>(BorderMenuItemDefaultExecute, BordersMenuItemDefaultCanExecute),
                        };
                    }
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/InsideHorizontalBorder_16x16.png", UriKind.Relative),
                            IsCheckable = true,
                            Command = new DelegateCommand<MenuItemData>(BorderMenuItemDefaultExecute, BordersMenuItemDefaultCanExecute),
                        };
                    }
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/InsideVerticalBorder_16x16.png", UriKind.Relative),
                            IsCheckable = true,
                            Command = new DelegateCommand<MenuItemData>(BorderMenuItemDefaultExecute, BordersMenuItemDefaultCanExecute),
                        };
                    }
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/DiagonalDownBorder_16x16.png", UriKind.Relative),
                            IsCheckable = true,
                            Command = new DelegateCommand<MenuItemData>(BorderMenuItemDefaultExecute, BordersMenuItemDefaultCanExecute),
                        };
                    }
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/DiagonalUpBorder_16x16.png", UriKind.Relative),
                            IsCheckable = true,
                            Command = new DelegateCommand<MenuItemData>(BorderMenuItemDefaultExecute, BordersMenuItemDefaultCanExecute),
                        };
                    }
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/DrawTable_16x16.png", UriKind.Relative),
                            IsCheckable = true,
                            Command = new DelegateCommand(DefaultExecuted, DefaultCanExecute),
                        };
                    }
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/ShowGridlines_16x16.png", UriKind.Relative),
                            IsCheckable = true,
                            Command = new DelegateCommand(DefaultExecuted, DefaultCanExecute),
                        };
                    }
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/BordersAndShading_16x16.png", UriKind.Relative),
                            Command = new DelegateCommand(DefaultExecuted, DefaultCanExecute),
                        };
                    }
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        GroupData Data = new GroupData(Str)
                        {
                            LargeImage = new Uri("/RibbonWindowSample;component/Images/StylesGroup.png", UriKind.Relative),
                            KeyTip = "ZS",
                        };
                        _dataCollection[Str] = Data;
                    }
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str, 
                            LargeImage = new Uri("/RibbonWindowSample;component/Images/Styles_32x32.png", UriKind.Relative),
                            ToolTipTitle = ToolTipTitle,
                            ToolTipDescription = ToolTipDescription,
                            KeyTip = "G",
                        };
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/Forecolor_16x16.png", UriKind.Relative),
                            IsVerticallyResizable = true,
                            KeyTip = "Y",
                        };
                        _dataCollection[Str] = menuItemData;
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/ChooseColor_16x16.png", UriKind.Relative),
                            IsVerticallyResizable = true,
                            KeyTip = "C",
                        };
                        _dataCollection[Str] = menuItemData;
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/ParagraphSpacing_16x16.png", UriKind.Relative),
                            KeyTip = "P",
                        };
                        _dataCollection[Str] = menuItemData;
                    }
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        singleCategory.Label = "Built-In";
                        singleCategory.GalleryItemDataCollection.Add(new ThemeFonts() { Label = "Office", Field2 = "Cambria", Field3 = "Calibri", Field1 = "/RibbonWindowSample;component/Images/ThemeFonts.png" });
                        singleCategory.GalleryItemDataCollection.Add(new ThemeFonts() { Label = "Office 2", Field2 = "Calibri", Field3 = "Cambria", Field1 = "/RibbonWindowSample;component/Images/ThemeFonts.png" });
                        singleCategory.GalleryItemDataCollection.Add(new ThemeFonts() { Label = "Office Classic", Field2 = "Arial", Field3 = "Times New Roman", Field1 = "/RibbonWindowSample;component/Images/ThemeFonts.png" });
                        singleCategory.GalleryItemDataCollection.Add(new ThemeFonts() { Label = "Office Classic 2", Field2 = "Arial", Field3 = "Arial", Field1 = "/RibbonWindowSample;component/Images/ThemeFonts.png" });
                        singleCategory.GalleryItemDataCollection.Add(new ThemeFonts() { Label = "Adjacency", Field2 = "Franklin Gothic", Field3 = "Franklin Gothic Book", Field1 = "/RibbonWindowSample;component/Images/ThemeFonts.png" });
                        singleCategory.GalleryItemDataCollection.Add(new ThemeFonts() { Label = "Angles", Field2 = "Cambria", Field3 = "Calibri", Field1 = "/RibbonWindowSample;component/Images/ThemeFonts.png" });
                        singleCategory.GalleryItemDataCollection.Add(new ThemeFonts() { Label = "Apex", Field2 = "Lucida Sans", Field3 = "Book Antiqua", Field1 = "/RibbonWindowSample;component/Images/ThemeFonts.png" });
                        singleCategory.GalleryItemDataCollection.Add(new ThemeFonts() { Label = "Apothecary", Field2 = "Book Antiqua", Field3 = "Century Gothic", Field1 = "/RibbonWindowSample;component/Images/ThemeFonts.png" });
                        singleCategory.GalleryItemDataCollection.Add(new ThemeFonts() { Label = "Aspect", Field2 = "Verdana", Field3 = "Verdana", Field1 = "/RibbonWindowSample;component/Images/ThemeFonts.png" });
                        singleCategory.GalleryItemDataCollection.Add(new ThemeFonts() { Label = "Austin", Field2 = "Century Gothic", Field3 = "Century Gothic", Field1 = "/RibbonWindowSample;component/Images/ThemeFonts.png" });
                        singleCategory.GalleryItemDataCollection.Add(new ThemeFonts() { Label = "Black Tie", Field2 = "Garamond", Field3 = "Garamond", Field1 = "/RibbonWindowSample;component/Images/ThemeFonts.png" });
                        singleCategory.GalleryItemDataCollection.Add(new ThemeFonts() { Label = "Civic", Field2 = "Georgia", Field3 = "Georgia", Field1 = "/RibbonWindowSample;component/Images/ThemeFonts.png" });
                        singleCategory.GalleryItemDataCollection.Add(new ThemeFonts() { Label = "Office", Field2 = "Cambria", Field3 = "Calibri", Field1 = "/RibbonWindowSample;component/Images/ThemeFonts.png" });
                        singleCategory.GalleryItemDataCollection.Add(new ThemeFonts() { Label = "Office", Field2 = "Cambria", Field3 = "Calibri", Field1 = "/RibbonWindowSample;component/Images/ThemeFonts.png" });
                        singleCategory.GalleryItemDataCollection.Add(new ThemeFonts() { Label = "Office", Field2 = "Cambria", Field3 = "Calibri", Field1 = "/RibbonWindowSample;component/Images/ThemeFonts.png" });
                        singleCategory.GalleryItemDataCollection.Add(new ThemeFonts() { Label = "Office", Field2 = "Cambria", Field3 = "Calibri", Field1 = "/RibbonWindowSample;component/Images/ThemeFonts.png" });
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        GroupData Data = new GroupData(Str)
                        {
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/Find_16x16.png", UriKind.Relative),
                            LargeImage = new Uri("/RibbonWindowSample;component/Images/Find_32x32.png", UriKind.Relative),
                            KeyTip="ZN",
                        };
                        _dataCollection[Str] = Data;
                    }
                ...
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        MenuItemData MenuItemData = new MenuItemData()
                        {
                            ...
                            ToolTipFooterTitle = ToolTipFooterTitle,
                            ToolTipFooterImage = new Uri("/RibbonWindowSample;component/Images/Help_16x16.png", UriKind.Relative),
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/GoTo_16x16.png", UriKind.Relative),
                            Command = new DelegateCommand(DefaultExecuted, DefaultCanExecute),
                            KeyTip = "G",
                        };
                        _dataCollection[Str] = MenuItemData;
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/Replace_16x16.png", UriKind.Relative),
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/Select_16x16.png", UriKind.Relative),
                            ToolTipTitle = ToolTipTitle,
                            ToolTipDescription = ToolTipDescription,
                            Command = new DelegateCommand(DefaultExecuted, DefaultCanExecute),
                            KeyTip="SL",
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        {
                            Label = Str,
                            SmallImage = new Uri("/RibbonWindowSample;component/Images/SelectionPane_16x16.png", UriKind.Relative),
                            ToolTipTitle = ToolTipTitle,
                            ToolTipDescription = ToolTipDescription,
                            Command = new DelegateCommand(DefaultExecuted, DefaultCanExecute),
                            KeyTip = "P",
            ...
            get
            {
                lock (_lockObject)
                {
                    ...
                    if (!_dataCollection.ContainsKey(Str))
                    {
                        ...
                        _dataCollection[Str] = new MenuButtonData()
                        {
                            LargeImage = new Uri("/RibbonWindowSample;component/Images/Table_32x32.png", UriKind.Relative),
                            Label = Str,
                            ToolTipTitle = ToolTipTitle,
                            ToolTipDescription = ToolTipDescription,
                            ToolTipFooterTitle = HelpFooterTitle,
        ...
        private static UserControlWord WordControl
        {
            get
            {
                if (Application.Current.Properties.Contains("WordControlRef"))
                {
