...
@WebServlet(name = "ServicesOffered_SelectAll_Controller", urlPatterns = {"/ServicesOffered_SelectAll_Controller"})
public class ServicesOffered_SelectAll_Controller extends BaseController {
	...
	*/
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			ArrayList<ServicesOfferedDTO> ds = bean.selectAll();
