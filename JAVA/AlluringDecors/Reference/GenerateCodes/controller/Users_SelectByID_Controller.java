...
@WebServlet(name = "Users_SelectByID_Controller", urlPatterns = {"/Users_SelectByID_Controller"})
	...
	*/
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			UsersDTO ds = bean.selectById(id);
			request.setAttribute("UsersDTO", ds);

			String url = "/views/admin/DetailOfUsers.jsp";
