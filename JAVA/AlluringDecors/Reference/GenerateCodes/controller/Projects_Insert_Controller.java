...
@WebServlet(name = "Projects_Insert_Controller", urlPatterns = {"/Projects_Insert_Controller"})
	...
	*/
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			item.setIDProjectStatus(Integer.parseInt(request.getParameter("IDProjectStatus")));
			item.setName((String)request.getParameter("Name"));
			item.setImage((String)request.getParameter("Image"));
			item.setDescription((String)request.getParameter("Description"));
			item.setBriefDescription((String)request.getParameter("BriefDescription"));
