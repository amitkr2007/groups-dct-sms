...
@WebServlet(name = "ServiceRequestDetail_Insert_Controller", urlPatterns = {"/ServiceRequestDetail_Insert_Controller"})
public class ServiceRequestDetail_Insert_Controller extends BaseController {
