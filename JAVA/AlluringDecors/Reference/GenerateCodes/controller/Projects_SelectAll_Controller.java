...
@WebServlet(name = "Projects_SelectAll_Controller", urlPatterns = {"/Projects_SelectAll_Controller"})
public class Projects_SelectAll_Controller extends BaseController {
	...
	*/
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			ArrayList<ProjectsDTO> ds = bean.selectAll();
