...
@WebServlet(name = "ShoppingCarts_Delete_Controller", urlPatterns = {"/ShoppingCarts_Delete_Controller"})
public class ShoppingCarts_Delete_Controller extends BaseController {
