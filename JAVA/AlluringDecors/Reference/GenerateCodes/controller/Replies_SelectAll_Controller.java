...
@WebServlet(name = "Replies_SelectAll_Controller", urlPatterns = {"/Replies_SelectAll_Controller"})
public class Replies_SelectAll_Controller extends BaseController {
	...
	*/
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			ArrayList<RepliesDTO> ds = bean.selectAll();
