...
@WebServlet(name = "Roles_SelectAll_Controller", urlPatterns = {"/Roles_SelectAll_Controller"})
public class Roles_SelectAll_Controller extends BaseController {
	...
	*/
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			ArrayList<RolesDTO> ds = bean.selectAll();
			request.setAttribute("RolesDTOs", ds);
