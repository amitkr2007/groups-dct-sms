...
<%
            ...
            if (request.getAttribute("BillsDTO") != null) {
                bill = (BillsDTO) request.getAttribute("BillsDTO");
            }
            ...
            $(document).ready(function() {
                $("#submit").click(function() {
                    ...
                    if($("#PaidAmount").val() == ''){
                        ...
                        hasError = true;
                    }else if(parseInt($("#PaidAmount").val()) <= 0){
                        $("#PaidAmountErrMsg").html("Paid amount must more than 0");
                        hasError = true;
                    }
        ...
        <div id="main-content">
            <div id="content-table-inner">
                <div id="table-content">
                    ...
                    <div id="table-content">
                        <h2>Update Bill</h2>
                        <form action="./Bills_Update_Controller" method="post">
                            <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                                ...
                                <tr>
                                    ...
                                    <td><span style="font-weight: bold; color: red;">$<%= bill.getBalanceAmount()%></span></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <th valign="top">Due Amount: </th>
                                    <td><span style="font-weight: bold; color: red;">$<%= bill.getDueAmount()%></span></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <th valign="top">Paid Amount: </th>
                                    <td><span style="font-weight: bold; color: blue;">$<%= total - bill.getBalanceAmount()%></span></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <th valign="top">Total Paid Amount: </th>
                                    <td><span style="font-weight: bold; color: red;">$<%= bill.getTotalPaidAmount()%></span></td>
                                    <td></td>
                                </tr>
                                <tr style="height: 5px;">
                                    <td colspan="2"></td>
                                ...
                                <tr>
                                    ...
                                    <td valign="top">
                                        ...
                                        <input type="hidden" name="BalanceAmount" value="<%= bill.getBalanceAmount()%>" />
