...
@WebServlet(name = "Bills_SelectByIDServiceRequest_Controller", urlPatterns = {"/Bills_SelectByIDServiceRequest_Controller"})
public class Bills_SelectByIDServiceRequest_Controller extends BaseController {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            ArrayList<BillsDTO> ds = bean.selectByIDServiceRequest(idservicerequest);

            request.setAttribute("BillsDTO", ds.get(0));

            // Update service request details
            ServiceRequestsDTO obj = svcRqtBean.selectById(idservicerequest);
            List<ServiceRequestDetailDTO> lstSvRqtDt = svDtbean.selectByIDServiceRequest(idservicerequest);
