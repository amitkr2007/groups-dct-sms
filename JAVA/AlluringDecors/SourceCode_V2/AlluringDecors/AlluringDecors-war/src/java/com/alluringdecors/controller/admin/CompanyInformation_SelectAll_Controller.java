...
@WebServlet(name = "CompanyInformation_SelectAll_Controller", urlPatterns = {"/CompanyInformation_SelectAll_Controller"})
public class CompanyInformation_SelectAll_Controller extends BaseController {
