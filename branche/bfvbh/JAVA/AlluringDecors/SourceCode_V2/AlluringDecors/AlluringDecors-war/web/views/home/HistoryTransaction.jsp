...
<%
    ArrayList<ServiceRequestsDTO> ds = (ArrayList<ServiceRequestsDTO>) request.getAttribute("ServiceRequestsDTOs");
                ...
                <div id="table-content">
                    ...
                    <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="./DetailOfTransaction?id=<%= item.getID()%>" title="Select" class="icon-5 info-tooltip""></a>
                            </td>
                        </tr>
                        <%
                                }
