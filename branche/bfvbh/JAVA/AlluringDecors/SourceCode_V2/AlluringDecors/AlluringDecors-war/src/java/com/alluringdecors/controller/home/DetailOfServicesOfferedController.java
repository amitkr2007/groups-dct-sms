...
@WebServlet(name = "DetailOfServicesOfferedController", urlPatterns = {"/DetailOfServicesOffered"})
public class DetailOfServicesOfferedController extends BaseController {
