...
@WebServlet(name = "ServicesOffered_Delete_Controller", urlPatterns = {"/ServicesOffered_Delete_Controller"})
public class ServicesOffered_Delete_Controller extends BaseController {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (!kq) {
                request.setAttribute("Message", "Delete failed: there is references to this table, so this action cannot be done");
            } 
