...
@WebServlet(name = "FeedBacks_SelectByID_Controller", urlPatterns = {"/FeedBacks_SelectByID_Controller"})
public class FeedBacks_SelectByID_Controller extends BaseController {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            FeedBacksDTO ds = bean.selectById(id);
            List<RepliesDTO> lstReplies = replyBean.selectByIDFeedBack(id);
