...
@WebServlet(name = "CompanyInformation_Delete_Controller", urlPatterns = {"/CompanyInformation_Delete_Controller"})
public class CompanyInformation_Delete_Controller extends BaseController {
