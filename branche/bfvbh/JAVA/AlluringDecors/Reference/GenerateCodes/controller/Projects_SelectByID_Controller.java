...
@WebServlet(name = "Projects_SelectByID_Controller", urlPatterns = {"/Projects_SelectByID_Controller"})
	...
	*/
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			ProjectsDTO ds = bean.selectById(id);
			request.setAttribute("ProjectsDTO", ds);

			String url = "/views/admin/DetailOfProjects.jsp";
