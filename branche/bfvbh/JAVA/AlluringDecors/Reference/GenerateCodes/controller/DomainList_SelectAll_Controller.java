...
@WebServlet(name = "DomainList_SelectAll_Controller", urlPatterns = {"/DomainList_SelectAll_Controller"})
public class DomainList_SelectAll_Controller extends BaseController {
