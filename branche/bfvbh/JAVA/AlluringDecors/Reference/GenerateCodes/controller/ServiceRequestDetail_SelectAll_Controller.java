...
@WebServlet(name = "ServiceRequestDetail_SelectAll_Controller", urlPatterns = {"/ServiceRequestDetail_SelectAll_Controller"})
public class ServiceRequestDetail_SelectAll_Controller extends BaseController {
	...
	*/
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			ArrayList<ServiceRequestDetailDTO> ds = bean.selectAll();
