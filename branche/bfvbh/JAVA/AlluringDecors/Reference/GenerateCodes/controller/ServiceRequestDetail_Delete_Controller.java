...
@WebServlet(name = "ServiceRequestDetail_Delete_Controller", urlPatterns = {"/ServiceRequestDetail_Delete_Controller"})
public class ServiceRequestDetail_Delete_Controller extends BaseController {
