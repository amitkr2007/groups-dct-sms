...
@WebServlet(name = "ServicesOffered_SelectByID_Controller", urlPatterns = {"/ServicesOffered_SelectByID_Controller"})
public class ServicesOffered_SelectByID_Controller extends BaseController {
	...
	*/
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			ServicesOfferedDTO ds = bean.selectById(id);
