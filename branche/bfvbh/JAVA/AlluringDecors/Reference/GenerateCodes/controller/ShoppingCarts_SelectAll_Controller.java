...
@WebServlet(name = "ShoppingCarts_SelectAll_Controller", urlPatterns = {"/ShoppingCarts_SelectAll_Controller"})
public class ShoppingCarts_SelectAll_Controller extends BaseController {
	...
	*/
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			ArrayList<ShoppingCartsDTO> ds = bean.selectAll();
