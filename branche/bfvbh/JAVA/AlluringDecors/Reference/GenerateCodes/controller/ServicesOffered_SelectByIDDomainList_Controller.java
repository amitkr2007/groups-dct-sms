...
@WebServlet(name = "ServicesOffered_SelectByIDDomainList_Controller", urlPatterns = {"/ServicesOffered_SelectByIDDomainList_Controller"})
public class ServicesOffered_SelectByIDDomainList_Controller extends BaseController {

	@EJB ServicesOfferedDAO bean;
	...
	*/
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String url = "/views/admin/SelectByIDDomainListServicesOffered.jsp";
